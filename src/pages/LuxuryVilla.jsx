          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <h3 className={`text-lg font-semibold mb-3 ${isDark ? 'text-white' : 'text-black'}`}>
                {t('luxuryVillasPage.realEstateFeatures.items.homeLocations.title', 'Home locations:')}
              </h3>
              <p className={`text-sm ${isDark ? 'text-gray-400' : 'text-gray-600'} leading-relaxed px-2`}>
                {t('luxuryVillasPage.realEstateFeatures.items.homeLocations.description', 'Duis aute irure dolor in rep in voluptate velit esse cillum dolore eu fugiat nulla pariatur.')}
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className={`text-lg font-semibold mb-3 ${isDark ? 'text-white' : 'text-black'}`}>
                {t('luxuryVillasPage.realEstateFeatures.items.structure.title', 'Structure:')}
              </h3>
              <p className={`text-sm ${isDark ? 'text-gray-400' : 'text-gray-600'} leading-relaxed px-2`}>
                {t('luxuryVillasPage.realEstateFeatures.items.structure.description', 'Duis aute irure dolor in rep in voluptate velit esse cillum dolore eu fugiat nulla pariatur.')}
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className={`text-lg font-semibold mb-3 ${isDark ? 'text-white' : 'text-black'}`}>
                {t('luxuryVillasPage.realEstateFeatures.items.moveInNow.title', 'Move in now:')}
              </h3>
              <p className={`text-sm ${isDark ? 'text-gray-400' : 'text-gray-600'} leading-relaxed px-2`}>
                {t('luxuryVillasPage.realEstateFeatures.items.moveInNow.description', 'Duis aute irure dolor in rep in voluptate velit esse cillum dolore eu fugiat nulla pariatur.')}
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className={`text-lg font-semibold mb-3 ${isDark ? 'text-white' : 'text-black'}`}>
                {t('luxuryVillasPage.realEstateFeatures.items.homeSecurity.title', 'Home security:')}
              </h3>
              <p className={`text-sm ${isDark ? 'text-gray-400' : 'text-gray-600'} leading-relaxed px-2`}>
                {t('luxuryVillasPage.realEstateFeatures.items.homeSecurity.description', 'Duis aute irure dolor in rep in voluptate velit esse cillum dolore eu fugiat nulla pariatur.')}
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-stretch">
            ...
            <div className="order-2 lg:order-1 flex">
              <div className="relative rounded-2xl overflow-hidden shadow-2xl w-full flex items-center">
                ...
                <div className="absolute top-4 right-4 bg-red-600 text-white px-4 py-2 rounded-lg font-bold text-sm">
                  {t('luxuryVillasPage.floorPlan.badge', 'Floor Plan')}
                </div>
              </div>
            </div>
            ...
            <div className="order-1 lg:order-2 flex flex-col justify-center">
              <p className={`text-lg mb-8 ${isDark ? 'text-gray-300' : 'text-gray-600'} leading-relaxed`}>
                {t('luxuryVillasPage.floorPlan.description', 'Discover the perfect blend of elegance and functionality in this meticulously designed luxury villa. Every detail has been carefully planned to provide the ultimate living experience.')}
              </p>
              ...
              <div className="grid grid-cols-2 gap-6 mb-8">
                <div className={`p-4 rounded-xl ${isDark ? 'bg-gray-800' : 'bg-gray-100'}`}>
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className={`text-2xl font-bold ${isDark ? 'text-white' : 'text-black'}`}>5,200</div>
                      <div className={`text-sm ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
                        {t('luxuryVillasPage.floorPlan.specs.sqft', 'Sq Ft')}
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className={`p-4 rounded-xl ${isDark ? 'bg-gray-800' : 'bg-gray-100'}`}>
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className={`text-sm ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
                        {t('luxuryVillasPage.floorPlan.specs.bedrooms', 'Bedrooms')}
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className={`p-4 rounded-xl ${isDark ? 'bg-gray-800' : 'bg-gray-100'}`}>
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className={`text-2xl font-bold ${isDark ? 'text-white' : 'text-black'}`}>7</div>
                      <div className={`text-sm ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
                        {t('luxuryVillasPage.floorPlan.specs.bathrooms', 'Bathrooms')}
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className={`p-4 rounded-xl ${isDark ? 'bg-gray-800' : 'bg-gray-100'}`}>
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className={`text-sm ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
                        {t('luxuryVillasPage.floorPlan.specs.garage', 'Car Garage')}
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-3 mb-8">
                {[
                  t('luxuryVillasPage.floorPlan.features.openConcept', 'Open-concept living and dining area'),
                  t('luxuryVillasPage.floorPlan.features.gourmetKitchen', 'Gourmet kitchen with premium appliances'),
                  t('luxuryVillasPage.floorPlan.features.masterSuite', 'Master suite with spa-like bathroom'),
                  t('luxuryVillasPage.floorPlan.features.smartHome', 'Smart home automation system'),
                  t('luxuryVillasPage.floorPlan.features.outdoorSpace', 'Expansive outdoor living space')
                ].map((feature, idx) => (
              ...
              <div className="flex flex-wrap gap-4">
                <button className="bg-red-600 hover:bg-red-700 text-white px-8 py-3 rounded-lg font-semibold transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                  {t('luxuryVillasPage.floorPlan.cta.schedule', 'Schedule Tour')}
                </button>
              </div>
            </div>
          </div>
