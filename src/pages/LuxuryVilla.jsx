    ...
    <div className={isDark ? 'bg-gray-900 text-white transition-colors' : 'bg-white text-black transition-colors'}>
        ...
        <div className="relative z-10 px-6 max-w-4xl">
          ...
          <ScrollAnimation animation="fade-in" stagger="scroll-stagger-3">
            <div className="mt-8 flex gap-6 justify-center items-center flex-wrap">
              ...
              >
                <span className="relative z-10">{t('luxuryVillasPage.hero.ctaExplore')}</span>
              ...
              >
                <span className="relative z-10">{t('luxuryVillasPage.hero.ctaSchedule')}</span>
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              {
                icon: "🏊‍♂️",
                titleKey: "luxuryVillasPage.features.items.infinityPool.title",
                descriptionKey: "luxuryVillasPage.features.items.infinityPool.description",
                gradient: "from-blue-500 to-cyan-500"
              },
              {
                icon: "🍷",
                titleKey: "luxuryVillasPage.features.items.wineCellar.title",
                descriptionKey: "luxuryVillasPage.features.items.wineCellar.description",
                gradient: "from-purple-500 to-pink-500"
              },
              {
                icon: "🎬",
                titleKey: "luxuryVillasPage.features.items.homeTheater.title",
                descriptionKey: "luxuryVillasPage.features.items.homeTheater.description",
                gradient: "from-gray-500 to-gray-700"
              },
              {
                icon: "🏋️‍♂️",
                titleKey: "luxuryVillasPage.features.items.privateGym.title",
                descriptionKey: "luxuryVillasPage.features.items.privateGym.description",
                gradient: "from-green-500 to-emerald-500"
              },
              {
                icon: "🌿",
                titleKey: "luxuryVillasPage.features.items.landscapedGardens.title",
                descriptionKey: "luxuryVillasPage.features.items.landscapedGardens.description",
                gradient: "from-green-400 to-teal-500"
              },
              {
                icon: "🚗",
                titleKey: "luxuryVillasPage.features.items.garageSpace.title",
                descriptionKey: "luxuryVillasPage.features.items.garageSpace.description",
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { 
                ...
                titleKey: 'luxuryVillasPage.gallery.items.grandEntrance.title',
                categoryKey: 'luxuryVillasPage.gallery.items.grandEntrance.category',
                price: '$2,500,000'
              },
              { 
                src: '/images/Modern Penthouse.jpg', 
                titleKey: 'luxuryVillasPage.gallery.items.masterSuite.title',
                categoryKey: 'luxuryVillasPage.gallery.items.masterSuite.category',
                price: '$3,800,000'
              },
              { 
                src: '/images/Contemporary Townhouse.jpg', 
                titleKey: 'luxuryVillasPage.gallery.items.livingArea.title',
                categoryKey: 'luxuryVillasPage.gallery.items.livingArea.category',
                price: '$1,200,000'
              },
              { 
                src: '/images/Waterfront Mansion.jpg', 
                titleKey: 'luxuryVillasPage.gallery.items.oceanView.title',
                categoryKey: 'luxuryVillasPage.gallery.items.oceanView.category',
                price: '$5,500,000'
              },
              { 
                src: '/images/Luxury Condo.jpg', 
                titleKey: 'luxuryVillasPage.gallery.items.modernKitchen.title',
                categoryKey: 'luxuryVillasPage.gallery.items.modernKitchen.category',
                price: '$950,000'
              },
              { 
                src: '/images/Estate Home.jpg', 
                titleKey: 'luxuryVillasPage.gallery.items.gardenTerrace.title',
                categoryKey: 'luxuryVillasPage.gallery.items.gardenTerrace.category',
                price: '$4,200,000'
              }
            ].map((item, idx) => (
              <div key={idx} className="group relative overflow-hidden rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 text-white transform translate-y-full group-hover:translate-y-0 transition-transform duration-300">
                  ...
                  <button className="mt-4 bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-lg text-sm font-semibold transition-colors duration-300 opacity-0 group-hover:opacity-100">
                    {t('luxuryVillasPage.gallery.viewDetails')}
                  </button>
                </div>
          ...
          <div className="text-center mt-12">
            <button className="group bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white px-8 py-4 font-bold text-lg rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1">
              <span className="flex items-center gap-2">
                {t('luxuryVillasPage.gallery.viewAll')}
      ...
      <section className={isDark ? 'py-24 bg-gray-900 relative overflow-hidden' : 'py-24 bg-white relative overflow-hidden'}>
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { icon: "🏌️‍♂️", titleKey: "luxuryVillasPage.location.amenities.privateGolf.title", descKey: "luxuryVillasPage.location.amenities.privateGolf.description", color: "from-green-500 to-emerald-500" },
              { icon: "🏊‍♂️", titleKey: "luxuryVillasPage.location.amenities.countryClub.title", descKey: "luxuryVillasPage.location.amenities.countryClub.description", color: "from-blue-500 to-cyan-500" },
              { icon: "🛍️", titleKey: "luxuryVillasPage.location.amenities.luxuryShopping.title", descKey: "luxuryVillasPage.location.amenities.luxuryShopping.description", color: "from-purple-500 to-pink-500" },
              { icon: "🍽️", titleKey: "luxuryVillasPage.location.amenities.fineDining.title", descKey: "luxuryVillasPage.location.amenities.fineDining.description", color: "from-orange-500 to-red-500" },
              { icon: "🏥", titleKey: "luxuryVillasPage.location.amenities.medicalCenter.title", descKey: "luxuryVillasPage.location.amenities.medicalCenter.description", color: "from-teal-500 to-blue-500" },
              { icon: "🎓", titleKey: "luxuryVillasPage.location.amenities.topSchools.title", descKey: "luxuryVillasPage.location.amenities.topSchools.description", color: "from-indigo-500 to-purple-500" }
            ].map((amenity, idx) => (
          ...
          <div className="mt-16 max-w-4xl mx-auto">
            <div className={isDark ? 'bg-gray-800 rounded-2xl p-8' : 'bg-white rounded-2xl p-8 shadow-lg'}>
              <h3 className={isDark ? 'text-2xl font-bold text-white mb-6 text-center' : 'text-2xl font-bold text-black mb-6 text-center'}>
                {t('luxuryVillasPage.investment.marketInsights.title')}
              </h3>
              <div className="grid md:grid-cols-3 gap-8 text-center">
                <div>
                  <div className={isDark ? 'text-3xl font-bold text-red-500 mb-2' : 'text-3xl font-bold text-red-600 mb-2'}>15+</div>
                  <div className={isDark ? 'text-white font-semibold mb-1' : 'text-black font-semibold mb-1'}>{t('luxuryVillasPage.investment.marketInsights.yearsExperience')}</div>
                  <div className={isDark ? 'text-gray-300 text-sm' : 'text-gray-600 text-sm'}>{t('luxuryVillasPage.investment.marketInsights.experienceDesc')}</div>
                </div>
                <div>
                  <div className={isDark ? 'text-3xl font-bold text-red-500 mb-2' : 'text-3xl font-bold text-red-600 mb-2'}>500+</div>
                  <div className={isDark ? 'text-white font-semibold mb-1' : 'text-black font-semibold mb-1'}>{t('luxuryVillasPage.investment.marketInsights.propertiesSold')}</div>
                  <div className={isDark ? 'text-gray-300 text-sm' : 'text-gray-600 text-sm'}>{t('luxuryVillasPage.investment.marketInsights.propertiesDesc')}</div>
                </div>
                <div>
                  <div className={isDark ? 'text-3xl font-bold text-red-500 mb-2' : 'text-3xl font-bold text-red-600 mb-2'}>$2.5B+</div>
                  <div className={isDark ? 'text-white font-semibold mb-1' : 'text-black font-semibold mb-1'}>{t('luxuryVillasPage.investment.marketInsights.totalSales')}</div>
                  <div className={isDark ? 'text-gray-300 text-sm' : 'text-gray-600 text-sm'}>{t('luxuryVillasPage.investment.marketInsights.salesDesc')}</div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="relative h-96 bg-cover bg-center" style={{ backgroundImage: "url('/images/Luxury Villa.jpg')" }}>
              ...
              <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-8">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  >
                    {t('luxuryVillasPage.contact.cta.call')}
                  </button>
                </div>
              </div>
            </div>
