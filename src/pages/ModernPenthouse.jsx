    ...
    <div className={isDark ? 'bg-gray-900 text-white transition-colors' : 'bg-white text-black transition-colors'}>
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="text-center mb-20">
            ...
            <h2 className={isDark ? 'text-5xl font-bold text-white mt-4 mb-6' : 'text-5xl font-bold text-black mt-4 mb-6'}>
              Unparalleled Modern Amenities
            </h2>
            <p className={isDark ? 'text-xl text-gray-300 max-w-3xl mx-auto' : 'text-xl text-gray-600 max-w-3xl mx-auto'}>
              Every detail has been carefully crafted to provide the ultimate in modern luxury living
            </p>
          </div>
            ...
            {[
              {
                ...
                description: "Floor-to-ceiling windows with panoramic city views and natural light",
                gradient: "from-blue-500 to-cyan-500"
              },
              {
                icon: "🍷",
                title: "Rooftop Terrace",
                description: "Private rooftop terrace with outdoor kitchen and dining area",
                gradient: "from-purple-500 to-pink-500"
              },
              {
                icon: "🎬",
                title: "Smart Home Theater",
                description: "State-of-the-art home theater with 4K projection and surround sound",
                gradient: "from-gray-500 to-gray-700"
              },
              {
                icon: "🏋️‍♂️",
                title: "Private Gym",
                description: "Fully equipped fitness center with personal trainer consultation",
                gradient: "from-green-500 to-emerald-500"
              },
              {
                icon: "🌿",
                title: "Sky Garden",
                description: "Professionally designed rooftop garden with exotic plants and water features",
                gradient: "from-green-400 to-teal-500"
              },
              {
                icon: "🚗",
                title: "Valet Parking",
                description: "Concierge valet parking service with electric charging stations",
      ...
      <section className={isDark ? 'py-24 bg-gray-900 relative' : 'py-24 bg-gray-50 relative'}>
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="text-center mb-16">
            ...
            <h2 className={isDark ? 'text-5xl font-bold text-white mt-4 mb-6' : 'text-5xl font-bold text-black mt-4 mb-6'}>
              Modern Penthouse Gallery
            </h2>
            <p className={isDark ? 'text-xl text-gray-300 max-w-3xl mx-auto' : 'text-xl text-gray-600 max-w-3xl mx-auto'}>
              Take a virtual tour through our most exquisite penthouse properties
            </p>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { src: '/images/Modern Penthouse.jpg', title: 'Skyline Living Room', price: '$3,800,000', category: 'Modern Penthouse' },
              { src: '/images/Luxury Villa.jpg', title: 'Master Suite', price: '$4,200,000', category: 'Penthouse' },
              { src: '/images/Contemporary Townhouse.jpg', title: 'Open Kitchen', price: '$2,100,000', category: 'Penthouse' },
              { src: '/images/Waterfront Mansion.jpg', title: 'City View', price: '$5,500,000', category: 'Penthouse' },
              { src: '/images/Luxury Condo.jpg', title: 'Rooftop Terrace', price: '$1,950,000', category: 'Penthouse' },
              { src: '/images/Estate Home.jpg', title: 'Sky Garden', price: '$4,200,000', category: 'Penthouse' }
            ].map((item, idx) => (
      ...
      <section className={isDark ? 'py-24 bg-gray-900 relative overflow-hidden' : 'py-24 bg-white relative overflow-hidden'}>
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { icon: "🏢", title: "Business District", desc: "Prime location in financial hub", color: "from-green-500 to-emerald-500" },
              { icon: "🏊‍♂️", title: "Rooftop Pool", desc: "Infinity pool with city views", color: "from-blue-500 to-cyan-500" },
            ...
            <div className={isDark ? 'bg-gray-800 rounded-2xl p-8' : 'bg-white rounded-2xl p-8 shadow-lg'}>
              ...
              <div className="grid md:grid-cols-3 gap-8 text-center">
                <div>
                  ...
                  <div className={isDark ? 'text-gray-300 text-sm' : 'text-gray-600 text-sm'}>In luxury real estate</div>
                </div>
                <div>
                  <div className={isDark ? 'text-3xl font-bold text-red-500 mb-2' : 'text-3xl font-bold text-red-600 mb-2'}>300+</div>
                  <div className={isDark ? 'text-white font-semibold mb-1' : 'text-black font-semibold mb-1'}>Properties Sold</div>
                  <div className={isDark ? 'text-gray-300 text-sm' : 'text-gray-600 text-sm'}>In Manhattan area</div>
                </div>
                <div>
                  ...
                  <div className={isDark ? 'text-gray-300 text-sm' : 'text-gray-600 text-sm'}>Luxury properties</div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="relative h-96 bg-cover bg-center" style={{ backgroundImage: "url('/images/Modern Penthouse.jpg')" }}>
              ...
              <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-8">
                <h3 className={isDark ? 'text-3xl font-bold text-white mb-4' : 'text-3xl font-bold text-white mb-4'}>
                  Ready to Experience Modern Luxury Living?
                </h3>
                <p className={isDark ? 'text-xl text-white/90 mb-8 max-w-2xl' : 'text-xl text-white/90 mb-8 max-w-2xl'}>
                  Contact our luxury real estate specialists to schedule your private viewing and discover your dream penthouse today.
                </p>
